        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyTicketLimit = table.Column<int>(type: "int", nullable: false),
                    ...
                    HasKnowledgeBase = table.Column<bool>(type: "bit", nullable: false),
                    HasEmailIntegration = table.Column<bool>(type: "bit", nullable: false),
                    HasCannedResponses = table.Column<bool>(type: "bit", nullable: false),
                    HasCSATSurveys = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CannedResponses_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketCategories_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationId = table.Column<int>(type: "int", nullable: false),
                    CurrentPeriodTicketCount = table.Column<int>(type: "int", nullable: false),
                    CurrentPeriodStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CustomMonthlyTicketLimit = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttachmentNotes", x => new { x.AttachmentId, x.NoteId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttachmentResponses", x => new { x.AttachmentId, x.ResponseId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSystemNote = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportAgents_Profiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teams_SupportAgents_SupervisorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttachmentNotes_NoteId",
                table: "AttachmentNotes",
                column: "NoteId");

            migrationBuilder.CreateIndex(
                name: "IX_AttachmentResponses_ResponseId",
                table: "AttachmentResponses",
                column: "ResponseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CannedResponses_OrganizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportAgents_ProfileId",
                table: "SupportAgents",
                column: "ProfileId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketCategories_OrganizationId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AttachmentNotes_Attachments_AttachmentId",
                table: "AttachmentNotes",
                column: "AttachmentId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AttachmentNotes_Notes_NoteId",
                table: "AttachmentNotes",
                column: "NoteId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AttachmentResponses_Attachments_AttachmentId",
                table: "AttachmentResponses",
                column: "AttachmentId",
                principalTable: "Attachments",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AttachmentResponses_Responses_ResponseId",
                table: "AttachmentResponses",
                column: "ResponseId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Notes_SupportAgents_SupportAgentId",
                table: "Notes",
                column: "SupportAgentId",
                principalTable: "SupportAgents",
                principalColumn: "Id",
