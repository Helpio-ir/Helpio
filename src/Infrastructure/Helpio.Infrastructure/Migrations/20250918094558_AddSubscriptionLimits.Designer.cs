...
namespace Helpio.Ir.Infrastructure.Migrations
{
    ...
    [Migration("20250918094558_AddSubscriptionLimits")]
    partial class AddSubscriptionLimits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Helpio.Ir.Domain.Entities.Business.Subscription", b =>
                {
                    ...
                    b.Property<DateTime>("CurrentMonthStartDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("CurrentMonthTicketCount")
                        .HasColumnType("int");
